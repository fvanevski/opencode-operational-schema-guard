...
export function replayFrictionScenario(mode) {
  ...
  const after = {
    ...
    avoided_local_verify_launches: 2,
    avoided_full_suite_executions: 2,
  ...
  return {
    ...
    metric_provenance: {
      ...
      after: "Deterministic six-target fixture executed in this process; wall_clock_duration_ms measures fixture computation only.",
    },
