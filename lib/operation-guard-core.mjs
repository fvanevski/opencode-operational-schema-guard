...
function freshReviewEnvelopeInferenceIsBounded(prompt, policy) {
  ...
  if (FRESH_REVIEW_OPEN_ENDED_SCOPE_SIGNAL.test(text)) return false
...
export function normalizeTaskPacket(args, policy = DEFAULT_POLICY) {
  ...
  const inferenceScopeBounded = type !== "fresh-review" || freshReviewEnvelopeInferenceIsBounded(prompt, policy)
