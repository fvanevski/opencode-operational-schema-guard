...
function beginAuthorityAdmission(state, declaration) {
  ...
  state.authorityAdmissionNotice = declaration.mode === "strict-start"
    ? `OPERATIONAL GUARD: strict starting-head admission is pending. ${strictStartPendingGuidance(declaration.binding)}`
    : `OPERATIONAL GUARD: exact-head target ${declaration.binding} is pending. ${targetPendingGuidance(declaration.binding)}`
}
