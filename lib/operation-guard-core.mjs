...
function bindSafetyState(state, safety) {
  state.safety = safety
  for (const key of ["authorityBinding", "authorityMode", "authorityStatus", "semanticReviewAuthority", "repositoryVerifyAuthority", "trustedActionsReceiptHead", "trustedActionsReceiptSha256", "planningBaseSha", "observedHead", "admissionObservedHead", "taskWorkspaceHead", "taskWorkspaceHeadStatus", "editedPaths", "highRiskEdit", "editGeneration", "reviewedGeneration", "verifiedGeneration", "campaignId", "campaignBaseHead", "campaignActive", "campaignPublished"]) {
...
function hydrateSafetyState(safety, persisted) {
  if (!persisted || ![1, 2, 3, 4, 5, 6].includes(persisted.version)) return
    ...
    "tool.execute.before": async (input, output) => {
      ...
      if (tool === "task") {
        ...
        try {
          ...
          if (planning?.status === "PARTITION_REQUIRED") registerPlannerPartitionObligation(state, requestedType, planning, policy)
