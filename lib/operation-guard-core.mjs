...
import { parseChildTerminal, semanticReviewAuthorityFromMessage, semanticReviewRequirement } from "./hybrid-workflow.mjs"
  ...
  return {
    ...
    "tool.execute.before": async (input, output) => {
      ...
      if (tool === "task") {
        ...
        if (type === "fresh-review" && state.semanticReviewAuthority === "central-owned") {
