...
function assertMounts(config, inspect) {
  ...
  for (const destination of expectedTmpfs) if (!observedTmpfsDestinations.has(destination)) blocked("runner container tmpfs mount set differs from readiness config")
}
