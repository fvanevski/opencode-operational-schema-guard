...
export function validateRunnerSettings(configInput, settings) {
  ...
  if (typeof settings.WorkFolder !== "string" || !settings.WorkFolder || settings.WorkFolder.length > 1024 || /[\0\r\n]/.test(settings.WorkFolder)) blocked("runner settings WorkFolder is invalid")
  return settings
}
