...
export function createOperationGuard(options = {}) {
  ...
  const protectedMutationRoots = stateDirectory
    ? [...(options.protectedMutationRoots ?? []), resolve(stateDirectory), resolve(UNTRACKED_QUARANTINE_OPERATION_ROOT)]
    : options.protectedMutationRoots
  const core = createCoreOperationGuard({ ...options, protectedMutationRoots })
