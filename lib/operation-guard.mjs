...
import { loadUntrackedQuarantineReceipt, loadUntrackedQuarantineSpec, receiptPath, runUntrackedQuarantine } from "./untracked-quarantine.mjs"
    ...
    "tool.execute.before": async (input, output) => {
      ...
      if (quarantine) {
        ...
        if (spec.action === "inspect") {
          ...
          pendingQuarantines.set(key(input), { action: "restore", spec })
        }
      }
      ...
      if (quarantine) {
        ...
        if (pending && exactQuarantinePass(output)) {
          ...
          if (pending.action === "inspect") {
            ...
            ledger.operations[existingIndex] = { ...ledger.operations[existingIndex], phase: "restored" }
          }
