...
async function runRepositoryOwnedRepoPrAssessment(spec, {
  ...
  try {
    ...
    for (const [anchor, label] of [[evidenceAnchor, "repository-owned evidence root"], [nativeAnchor, "repository-owned native-result root"], [reservationAnchor, "repository-owned reservation root"]]) {
      try {
